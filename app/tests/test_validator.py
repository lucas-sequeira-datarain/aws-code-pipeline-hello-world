...
def test_validate_list_of_numbers_valid_list():
    ...
    assert validate_list_of_numbers(VALID_NUMBERS_LIST) is True
...
def test_validate_list_of_numbers_invalid_list():
    ...
    assert validate_list_of_numbers(INVALID_NUMBERS_LIST) is False
...
def test_validate_list_of_numbers_invalid_empty_list():
    ...
    assert validate_list_of_numbers(INVALID_NUMBERS_EMPTY_LIST) is False
...
def test_validate_list_of_numbers_invalid_non_list():
    ...
    assert validate_list_of_numbers(INVALID_NUMBERS_NON_LIST) is False
...
def test_validate_list_of_numbers_invalid_non_list_none():
    ...
    assert validate_list_of_numbers(INVALID_NUMBERS_NON_LIST_NONE) is False
